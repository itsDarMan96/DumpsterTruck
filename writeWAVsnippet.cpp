...
void writeFileWaveHeader(FILE *fp,int const sampleRate,
        short int const numChannels,
        short int const bitsPerSample)
 {
 WaveHeader wav1= makeWaveHeader(sampleRate,numChannels.bitsPerSample);
 fwrite(&wav1,sizeof(WaveHeader),1,fp);
 }
